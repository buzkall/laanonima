...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            /*
             * Whoever looks after the site, like La Cupida's credit warnings
             * (site.admin_email). An empty ADMIN_EMAIL falls back to the shop's
             * contact address so a failed backup is never mailed to anybody.
             */
