...
return [
     ...
     *
     * The package also ships casts for spatie/laravel-data and
     * spatie/data-transfer-object. Neither is installed here, and a cast keyed
     * by a class that does not exist is a PHPStan error rather than an inert
     * line, so both are gone until something needs them. A date is the only
     * non-scalar a setting carries today: CupidaSettings::$credit_topped_up_at.
     */
    'global_casts' => [
