...
Only role `autor` gets a slug. A translator listed in "Quién lo escribe" is plain text, and `/autor/<their-slug>` is a 404 — deliberate, the page is "books by this author", not "everyone who touched this book".
