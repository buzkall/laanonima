---
paths:
  - 'app/Filament/Pages/CorreosPlayground.php,config/correos.php,config/correos-shipping-sdk.php'
---
...
Contract numbers and the sender live in `config/correos.php`, not in the published `config/correos-shipping-sdk.php`: the SDK never reads them (they travel in the payload), and a re-publish of the package config would wipe them.
