...
>
    <section class="bg-[var(--cover)] px-[clamp(22px,5vw,80px)] pt-[clamp(48px,7vw,104px)] pb-[clamp(40px,5vw,72px)] text-[var(--on-cover)]">
        <h1 class="font-display m-0 max-w-[18ch] text-[clamp(40px,5.4vw,88px)]/[0.96] font-normal tracking-[-0.01em] text-balance">
    ...
    <main class="bg-paper text-ink pt-[clamp(28px,3vw,48px)] pb-[clamp(48px,6vw,88px)]">
        @if ($arrangement->books->isEmpty())
            <p class="mx-auto my-[clamp(40px,6vw,88px)] max-w-[520px] px-[clamp(22px,5vw,80px)] text-center text-[22px] text-balance italic">
        ...
        @else
            ...
            <div data-shelf data-seed="{{ $arrangement->seed }}">
                <div class="shelf" data-shelf-frame>
                    ...
                    {{-- Outside the scroller, which hides its overflow: a card
                     drawn above a tall book has to stand clear of the row. --}}
